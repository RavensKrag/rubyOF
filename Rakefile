...
namespace :c_extension do
	...
	task :final_link do
		...
		Dir.chdir(app_path) do
			...
			# # $objs
			# #{path}/Fbo.o #{path}/Graphics.o #{path}/TrueTypeFont.o #{app_path}/app.o #{app_path}/app_factory.o #{path}/image.o #{path}/launcher.o #{path}/rubyOF.o
...
# TODO: Update documentation, explain what this task is actually for
# + trying to bridge the bindings and the project code
# + don't want to touch oF core at all though
