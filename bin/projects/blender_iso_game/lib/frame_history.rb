class FrameHistory
  ...
  module States
      ...
      def seek(frame_number)
        ...
        @outer.instance_eval do
          if frame_number >=0 && frame_number <= @history.length-1 # [0, len-1]
            ...
            # @context.load_state @history[@executing_frame]
    ...
    class Finished < State
      ...
      def start
        ...
        @outer.instance_eval do
          if @final_frame == nil
            # @history[@executing_frame] = @context.snapshot_gamestate
            @history.snapshot_gamestate_at @executing_frame
  ...
  # rather than executing this frame immediately, assign the passed block some frame number, and compare that number to the desired frame of execution. then, the desired frame number can be manually scrubbed back-and-forth in order to control the point of execution
