...
void ofApp::setup(){
	...
	ofTrueTypeFontSettings settings("/usr/share/fonts/truetype/fonts-japanese-gothic.ttf", 20); // This works fine
...
void ofApp::draw(){
	...
	mUnicodeFont.drawString("app: Testing こんにちは", 200,200);
