[:$stdin, :$stdout, :$stderr, :$>, :$<, :$., :$FILENAME, :$-i, :$*, :$NONINSTALLFILES, :$SAFE, :$fileutils_rb_have_lchmod, :$fileutils_rb_have_lchown, :$CPPFLAGS, :$LDFLAGS, :$LIBS, :$LIBRUBYARG, :$LIBRUBYARG_STATIC, :$CXXFLAGS, :$LDSHARED_CXX, :$&, :$`, :$', :$+, :$=, :$KCODE, :$-K, :$CFLAGS, :$CXX, :$RICE_CPPFLAGS, :$RICE_LDFLAGS, :$RICE_PREFIX, :$RICE_USING_MINGW32, :$DEFLIBPATH, :$OBJEXT, :$DLDFLAGS, :$LIBPATH, :$static, :$config_h, :$VERBOSE, :$-v, :$-w, :$-W, :$DEBUG, :$-d, :$0, :$-p, :$PROGRAM_NAME, :$rubylibdir, :$archdir, :$configure_args, :$libdir, :$-l, :$-a, :$arg_config, :$typeof, :$PKGCONFIG, :$defs, :$default_static, :$extconf_h, :$VPATH, :$headers, :$LIBRUBYARG_SHARED, :$warnflags, :$ruby, :$preload, :$cleanfiles, :$distcleanfiles, :$sitedir, :$sitelibdir, :$sitearchdir, :$vendordir, :$vendorlibdir, :$vendorarchdir, :$mswin, :$bccwin, :$mingw, :$cygwin, :$netbsd, :$haiku, :$solaris, :$universal, :$dest_prefix_pattern, :$nmake, :$target, :$LIBEXT, :$distcleandirs, :$objs, :$INSTALLFILES, :$extout, :$extmk, :$extout_prefix, :$installed_list, :$ignore_error, :$ASMEXT, :$hdrdir, :$topdir, :$top_srcdir, :$arch_hdrdir, :$srcs, :$?, :$$, :$makefile_created, :$enable_shared, :$make, :$curdir, :$;, :$-F, :$,, :$/, :$_, :$~, :$\, :$-0, :$:, :$-I, :$LOAD_PATH, :$", :$LOADED_FEATURES, :$have_devel, :$INCFLAGS, :$ARCH_FLAG, :$LOCAL_LIBS, :$libs, :$srcdir, :$EXEEXT, :$@, :$!]
$CXX
   "g++"
$LIBS
