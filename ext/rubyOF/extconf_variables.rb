[:$stdin, :$stdout, :$stderr, :$>, :$<, :$., :$FILENAME, :$-i, :$*, :$NONINSTALLFILES, :$SAFE, :$fileutils_rb_have_lchmod, :$fileutils_rb_have_lchown, :$CPPFLAGS, :$LDFLAGS, :$LIBS, :$LIBRUBYARG, :$LIBRUBYARG_STATIC, :$CXXFLAGS, :$LDSHARED_CXX, :$&, :$`, :$', :$+, :$=, :$KCODE, :$-K, :$CFLAGS, :$warnflags, :$CXX, :$RICE_CPPFLAGS, :$RICE_LDFLAGS, :$RICE_PREFIX, :$RICE_USING_MINGW32, :$DEFLIBPATH, :$OBJEXT, :$DLDFLAGS, :$LIBPATH, :$static, :$VERBOSE, :$-v, :$-w, :$-W, :$DEBUG, :$-d, :$0, :$PROGRAM_NAME, :$configure_args, :$libdir, :$rubylibdir, :$default_static, :$-l, :$-a, :$-p, :$archdir, :$defs, :$arg_config, :$typeof, :$PKGCONFIG, :$config_h, :$extconf_h, :$VPATH, :$headers, :$LIBRUBYARG_SHARED, :$ruby, :$preload, :$cleanfiles, :$distcleanfiles, :$nmake, :$sitedir, :$sitelibdir, :$sitearchdir, :$vendordir, :$vendorlibdir, :$vendorarchdir, :$mswin, :$bccwin, :$mingw, :$cygwin, :$netbsd, :$haiku, :$solaris, :$universal, :$dest_prefix_pattern, :$target, :$LIBEXT, :$distcleandirs, :$objs, :$INSTALLFILES, :$srcs, :$extout, :$extmk, :$extout_prefix, :$ignore_error, :$ASMEXT, :$hdrdir, :$topdir, :$top_srcdir, :$arch_hdrdir, :$installed_list, :$makefile_created, :$?, :$$, :$enable_shared, :$make, :$curdir, :$;, :$-F, :$,, :$/, :$_, :$~, :$\, :$-0, :$:, :$-I, :$LOAD_PATH, :$", :$LOADED_FEATURES, :$have_devel, :$INCFLAGS, :$ARCH_FLAG, :$LOCAL_LIBS, :$libs, :$srcdir, :$EXEEXT, :$@, :$!]
$CXX
   "g++"
$LIBS
