[:$stdin, :$stdout, :$stderr, :$>, :$<, :$., :$FILENAME, :$-i, :$*, :$NONINSTALLFILES, :$SAFE, :$fileutils_rb_have_lchmod, :$fileutils_rb_have_lchown, :$CPPFLAGS, :$LDFLAGS, :$LIBS, :$LIBRUBYARG, :$LIBRUBYARG_STATIC, :$CXXFLAGS, :$LDSHARED_CXX, :$&, :$`, :$', :$+, :$=, :$KCODE, :$-K, :$CXX, :$RICE_CPPFLAGS, :$RICE_LDFLAGS, :$RICE_PREFIX, :$RICE_USING_MINGW32, :$DEFLIBPATH, :$OBJEXT, :$DLDFLAGS, :$LIBPATH, :$static, :$config_h, :$default_static, :$VERBOSE, :$-v, :$-w, :$-W, :$DEBUG, :$-d, :$0, :$-l, :$PROGRAM_NAME, :$archdir, :$defs, :$libdir, :$rubylibdir, :$-a, :$configure_args, :$-p, :$typeof, :$PKGCONFIG, :$extconf_h, :$arg_config, :$VPATH, :$headers, :$LIBRUBYARG_SHARED, :$warnflags, :$ruby, :$preload, :$cleanfiles, :$distcleanfiles, :$sitedir, :$sitelibdir, :$sitearchdir, :$vendordir, :$vendorlibdir, :$vendorarchdir, :$mswin, :$bccwin, :$mingw, :$cygwin, :$netbsd, :$haiku, :$solaris, :$universal, :$dest_prefix_pattern, :$objs, :$nmake, :$target, :$LIBEXT, :$distcleandirs, :$installed_list, :$extout, :$extmk, :$extout_prefix, :$INSTALLFILES, :$ignore_error, :$hdrdir, :$topdir, :$top_srcdir, :$arch_hdrdir, :$ASMEXT, :$srcs, :$?, :$$, :$makefile_created, :$enable_shared, :$make, :$curdir, :$;, :$-F, :$,, :$/, :$_, :$~, :$\, :$-0, :$:, :$-I, :$LOAD_PATH, :$", :$LOADED_FEATURES, :$have_devel, :$INCFLAGS, :$CFLAGS, :$ARCH_FLAG, :$LOCAL_LIBS, :$libs, :$srcdir, :$EXEEXT, :$@, :$!]
$CXX
   "g++"
$LIBS
